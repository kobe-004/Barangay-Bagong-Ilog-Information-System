...
<head>
    ...
    margin-left: 105px;
        ...
        .deletebuttonofficials, .unarchive-officials{
            padding: 10px;
            background-color: #0F044C;
            color: #EEEEEE;
            border: none;
        ...
        .deletebuttonofficials:hover, .unarchive-officials:hover {
            background-color: #365486;
            transform: scale(1.1);
        }
...
<div class="header">
    ...
    <div class="officials-container">
        ...
        <div class="officialstitle">
            <h1>Archived Barangay Officials</h1>
        </div>
        <div id="table-wrapper-officials">
            <table>
                ...
                <tbody>
                    <?php 
                    $sql = "SELECT * FROM barangay_official WHERE `status` = 'inactive'";
                    $result = mysqli_query($connect, $sql);
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class=\"no-print\"><a href=\"officials.php?idOfficial=" . $row['official_id'] . "\" class=\"unarchive-officials\" name=\"archiveButton\"><img src=\"./assets/arrow-up-circle-fill.svg\" height=\"35\"></a></td>";
                        echo "<td class=\"no-print\"><button class=\"deletebuttonofficials\" onclick=\"showDeleteOfficials(" . $row['official_id'] . ")\"><img src=\"./assets/trash.svg\" height=\"35\"></button></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
