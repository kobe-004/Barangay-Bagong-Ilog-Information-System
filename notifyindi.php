...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->Body    = "You can now pick up your requested certificate of barangay indigency at the barangay hall!";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->Body    = "Your requested certificate of barangay indigency has been declined. Submit another request.";
