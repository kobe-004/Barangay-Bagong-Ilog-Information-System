...
if (isset($_POST['printofficial'])) {
    ...
    class MYPDF extends TCPDF {
        ...
        public function Body($data, $conn) { 
            ...
            $this->SetFont('helvetica', 'B', 17);
             ...
             $this->Cell(0, 10, 'OFFICIALS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
             $this->Ln(10); 
             $this->SetFont('helvetica', '', 11);
             $content = '<table border="1">';
             $content .= '<thead>'; 
             $content .= '<tr><th style="font-weight: bold; text-align: center;">Last Name</th><th style="font-weight: bold; text-align: center;">First Name</th><th style="font-weight: bold; text-align: center;">Middle Name</th><th style="font-weight: bold; text-align: center;">Age</th><th style="font-weight: bold; text-align: center;">Position</th><th style="font-weight: bold; text-align: center;">Term Start</th><th style="font-weight: bold; text-align: center;">Term End</th><th style="font-weight: bold; text-align: center;">Status</th></tr>';
             $content .= '</thead>';
             ...
             if ($stmt) { 
                 if ($stmt->execute()) {
                     ...
                     while ($data = $result->fetch_assoc()) {
                         ...
                         $content .= "<td style='text-align: center;'>{$data['position']}</td>";
                         $content .= "<td style='text-align: center;'>{$data['term_start']}</td>";
                         $content .= "<td style='text-align: center;'>{$data['term_end']}</td>";
    ...
    $pdf->SetAuthor('SAGAD');
    $pdf->SetTitle('Officials');
    $pdf->SetSubject('Officials');
    $pdf->SetKeywords('off');
