    ...
    class MYPDF extends TCPDF {
        ...
        public function Body($data, $conn) { 
            ...
            $this->SetFont('helvetica', 'B', 17);
             ...
             $this->Cell(0, 10, 'EVENTS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
             $this->Ln(10); 
             $this->SetFont('helvetica', '', 11);
             ...
             <th style="font-weight: bold; text-align: center;">Type of Event</th>
             ...
             if ($stmt) { 
                 if ($stmt->execute()) {
                     ...
                     while ($data = $result->fetch_assoc()) {
                         $content .= "<tr>";
                         $content .= "<td style='text-align: center;'>{$data['Event_Name']}</td>";
                         $content .= "<td style='text-align: center;'>{$data['Type_of_Event']}</td>";
