...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->Body    = "You can now pick up your requested business clearance at the barangay hall!";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->Body    = "Your requested business clearance has been declined. Submit another request.";
