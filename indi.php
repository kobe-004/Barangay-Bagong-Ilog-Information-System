...
include'notifyindi.php';
$query = "SELECT * FROM pending_documents";
$result = mysqli_query($connect, $query);
$selectedFilter = isset($_GET['filter']) ? $_GET['filter'] : null;

$filteredQuery = "SELECT * FROM pending_documents WHERE document_type = 'Barangay Indigency'";
...
if (isset($_POST['print']) || isset($_POST['accept'])) {
    ...
    class MYPDF extends TCPDF {
        ...
        public function Body($full_name, $address, $reason_for_application, $requester_name) {
            ...
            $this->SetX(62); 
            $this->Cell(0, 10, 'CERTIFICATE OF INDIGENCY', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            $this->Ln(3);
            $this->SetLineWidth(0.5);
            $this->Line(63, $this->GetY(), 152, $this->GetY());
            ...
            $this->SetX(40); 
            $this->Cell(0, 10, 'This is to certify that Mr./Mrs./Ms. ' . $full_name . '' , 0, false, 'L', 0, '', 0, false, 'M', 'M');
           
            $this->Ln(7); 
            $this->SetX(33); 
            $this->Cell(0, 10, ' is the resident of this barangay with address at '. $address . '' , 0, false, 'L', 0, '', 0, false, 'M', 'M');
            
            $this->SetFont('helvetica', 'B', 13);
            $this->Ln(7); 
            $this->SetX(33); 
            $this->Cell(0, 10, 'Barangay Bagong Ilog, Pasig City.', 0, false, 'L', 0, '', 0, false, 'M', 'M');

            $this->SetFont('helvetica', '', 13);
            $this->Ln(10); 
            $this->SetX(40);
            $this->Cell(0, 10, 'Further certify that his/her family belongs to indigent and under-', 0, false, 'L', 0, '', 0, false, 'M', 'M');

            $this->Ln(7); 
            $this->SetX(33); 
            $this->Cell(0, 10, 'employed families of this Barangay. ', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            
            $this->Ln(10); 
            $this->SetX(40); 
            $this->Cell(0, 10, 'This certification is being issued upon the request of Mr./Mrs./Ms. ' , 0, false, 'L', 0, '', 0, false, 'M', 'M');
            
            $this->Ln(7); 
            $this->SetX(33); 
            $this->Cell(0, 10, $requester_name . ', as requirement for '. $reason_for_application . '.' , 0, false, 'L', 0, '', 0, false, 'M', 'M');

            $this->Ln(10); 
            $this->SetX(40); 
            $this->Cell(0, 10, 'GIVEN this date '.date('F,j,Y').' at Bagong Ilog, Barangay Hall, Pasig City.', 0, false, 'L', 0, '', 0, false, 'M', 'M');
    ...
    if (isset($_POST['full_name']) && isset($_POST['address']) && isset($_POST['reason_for_application ']) && isset($_POST['requester_name'])) {
    ...
    if (isset($_POST['full_name']) && isset($_POST['address']) && isset($_POST['reason_for_application']) && isset($_POST['requester_name'])) {
        ...
        $reason_for_application  = $_POST['reason_for_application'];
        $requester_name = $_POST['requester_name'];
        $pdf->Body($full_name, $address, $reason_for_application , $requester_name);
    } else {
    ...
    $pdf->Output('CertificateOfIndigency.pdf', 'I');
    exit;
}
?>
<?php
require_once('connection.php');
$query = "SELECT * FROM pending_documents WHERE document_type = 'Barangay Indigency'";
$result = mysqli_query($connect, $query);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
                    <div class="card-header">
                        ...
                        <div id="headd">
                            <label for="title">Barangay Indigency</label>
                        </div>
                        <div class="btn-group">
                    ...
                    <div class="scrollable-table">
                        <table class="table_bordered">
                            <tr>
                                ...
                                <td><b>Full Name</b></td>
                                <td><b>Reason For Application</b></td>
                                <td><b>Address</b></td>
                            ...
                            ?>
                                ...
                                <td><?php echo !is_null($row['requester_name']) ? $row['requester_name'] : 'N/A'; ?></td>
                                ...
                                <td>
                                    <form method="post" action="">
                                        ...
                                        <input type="hidden" name="requester_name" value="<?php echo $row['requester_name']; ?>">
